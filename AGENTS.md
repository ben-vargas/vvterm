...
- `Features/TerminalSessions` is in progress, with domain types, session/tab managers, tmux prompt coordination, live activity support, and tmux prompt UI migrated.
